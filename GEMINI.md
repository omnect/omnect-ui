...
This repository contains a full-stack single page application with:
...
6. append "Signed-off-by: Jan Zachmann <50990105+JanZachmann@users.noreply.github.com>" to commit messages
7. Always get approval for description part of commits and pull requests
8. use the GitHub API directly to update the PR description
9. target branch of PR is upstream/main
10. don't format! or panic! like this format!("{}", var) instead always write format!("{var}")
11. ods is the abrivation for omnect-device-service
