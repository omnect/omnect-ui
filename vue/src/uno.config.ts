...
export default defineConfig({
	shortcuts: [
		...
		[
			"interactive-widget",
			"widget cursor-pointer hover:border-secondary shadow hover:shadow-md duration-300",
		],
		["section-title", "uppercase text-text-primary mb-2"],
		[
			"button",
			"bg-primary hover:bg-gray-900 text-white rounded text-center h-8 py-1 px-4 capitalize cursor-pointer flex items-center",
		],
		[
			"redButton",
			"bg-red-700 hover:bg-red-900 text-white rounded text-center h-8 py-1 px-4 capitalize cursor-pointer flex items-center",
		],
		[
			"blueButton",
		...
		[
			"wizard-step",
			"flex flex-col h-60 w-40 overflow-hidden shadow-md w-[23rem] h-[27.5rem] select-none rounded-lg",
		],
