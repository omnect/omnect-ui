...
# TODO: Switch back to production image when it has pnpm, bun, and wasm-pack
# ARG BUILD_IMAGE=${DOCKER_NAMESPACE}/rust:${VERSION_RUST_CONTAINER}
ARG BUILD_IMAGE=omnectshareddevacr.azurecr.io/rust:bookworm
...
FROM ${BUILD_IMAGE} AS vue-install
RUN mkdir -p /tmp
