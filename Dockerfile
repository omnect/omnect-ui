...
# Stage 2: Install Vue dependencies (parallel with typegen)
...
# Stage 3: Build Vue UI using generated types from typegen stage
...
# Stage 4: Build Rust backend for target architecture with embedded frontend
